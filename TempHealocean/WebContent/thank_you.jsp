...
<TABLE align="center" BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH=800>
		...
		<P>
			<FONT color=#0000ff face=굴림 size=3><CENTER>
					<STRONG>[회원정보 등록(수정)결과 ]</STRONG>
					<CENTER></FONT>
		</P>
		<P>
			<FONT face=굴림 size=3><CENTER>
					<STRONG><a href="member/login.jsp">로그인하러 이동</a></STRONG>
					<CENTER></FONT>
		</P>
		<table align="center""> 
			<tr>
			...
			<tr>
				<td>회원이름 :</td>
				<td><B><%=member.getName()%> 이 등록(변경) 되었습니다.</B></td>
			</tr>
		</table>
	</TABLE>
