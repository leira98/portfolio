...
<br>
<form method="post" name="writeform" action="../qnaController?choice=insert-board" onsubmit="return writeSave()">
...
<table width="1000" border="1" cellspacing="0" cellpadding="0"  bgcolor="<%=bodyback_c%>" align="center">
   <tr>
    <td align="right" colspan="2" bgcolor="<%=value_c%>">
	    <a href="../qnaController?choice=getAll-board"> 글목록</a> 
   </td>
   </tr>
   <tr>
...
<tr>      
 <td colspan=2 bgcolor="<%=value_c%>" align="center"> 
  ...
  <input type="button" value="목록보기" OnClick="window.location='../qnaController?choice=getAll-board'">
</td></tr></table>    
 <%
  }catch(Exception e){}
%>     
