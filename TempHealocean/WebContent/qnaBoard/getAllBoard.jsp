...
<%
    if (count > 0) {
        ...
        if (startPage > 10) {    %>
        <a href="qnaController?choice=getAll-board&pageNum=<%= startPage - 10 %>&startRow=<%=(startPage - 1) * 10 + 1%>&endRow=<%=startPage * 10%>">[이전]</a>
<%      }
...
<%                                      
        ...
        <a href="qnaController?choice=getAll-board&pageNum=<%= startPage + 10 %>&startRow=<%=(startPage - 1) * 10 + 1%>&endRow=<%=startPage * 10%>">[다음]</a>
<%
        }
    }
%>
