...
import exception.RecordDuplicatedException;
...
//    void insertMember(Member member)  {
        String INSERT_STMT
                ...
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        System.out.println("MemberEntity insertMember : "+INSERT_STMT);
        ...
        try {
            ...
            insert_stmt.setString(4, member.email);
            insert_stmt.setString(5, member.tel);
            insert_stmt.setString(6, member.zipcode);
            insert_stmt.setString(7, member.address);
            insert_stmt.setInt(8, member.point);
            insert_stmt.setDate(9, new Date(System.currentTimeMillis()));
            // Perform the SQL INSERT
            insert_stmt.executeUpdate();
            // Handle any SQL errors
        } catch (SQLException se) {
            System.out.println("MemberEntity insert() Error :" + se.getMessage());
            se.printStackTrace();
  ...
  */
    public MemberVO selectMember(String memId) throws RecordNotFoundException {
        ...
        System.out.println("MemberEntity selectMember " + RETRIEVE_STMT);
        ...
        try{
            ...
            if(rs.next()){
                ...
                member.setEmail( rs.getString(4).trim());
                member.setTel( rs.getString(5).trim());
                member.setZipcode( rs.getString(6).trim());
                member.setAddress( rs.getString(7).trim());
    ...
    public void updateMember(MemberVO member) throws RecordNotFoundException {
        ...
        System.out.println("MemberEntity updateMember UPDATE_STMT : " + UPDATE_STMT);
        ...
        try{          
            ...
            stmt.setString(7, member.getMemID());
            
            int updCount = stmt.executeUpdate();            
            System.out.println("BasketPurchaserEntity deleteBasket delCount :" + updCount);
    ...
    public MemberVO compareID(String memID,String Passwd) {
        ...
        System.out.println("MemberEntity compareID : " + RETRIEVE_STMT);
    ...
    public boolean memIDExist(String memID) {
        ...
        System.out.println("MemberEntity memIDExist query : " + RETRIEVE_STMT);
